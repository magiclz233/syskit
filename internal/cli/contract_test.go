...
func TestDangerousHelpMentionsApplyAndYes(t *testing.T) {
	cases := []struct {
		...
		{args: []string{"fix", "run", "--help"}, expected: []string{"--apply --yes", "审计"}},
		{args: []string{"service", "start", "--help"}, expected: []string{"--apply --yes", "审计"}},
		{args: []string{"service", "enable", "--help"}, expected: []string{"--apply --yes", "审计"}},
		{args: []string{"startup", "disable", "--help"}, expected: []string{"--apply --yes", "审计"}},
		{args: []string{"file", "empty", "--help"}, expected: []string{"--apply --yes", "审计"}},
		{args: []string{"file", "dedup", "--help"}, expected: []string{"--apply --yes", "审计"}},
	}
